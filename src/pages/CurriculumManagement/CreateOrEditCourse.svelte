                ...
                const reinitValues = {
					...
					[curriculumFormKeys.youtube_video_entries_key]:
						...
						newData[curriculumFormKeys.youtube_video_entries_key].length > 0
							? newData[curriculumFormKeys.youtube_video_entries_key]
							: [
									{
			...
			<form use:form enctype="multipart/form-data">
				...
				<div class="field">
					...
					<label class="label"
						>Curriculum plan
						<div class="control">
							<a href={getResourcesAPIByID($data[curriculumFormKeys.curriculum_plan_id_key])} target="_blank">{$data[curriculumFormKeys.curriculum_plan_file_name_key] || ""}</a>
							<InputFileContainer
								filename={$data[
															...
															{#each ($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_teacher_notes_key] || []) as teacherNote, teacherNoteIndex}
																<div>
																	<input
																		...
																		type="hidden"
																		style="display: none;"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_teacher_notes_key}.{teacherNoteIndex}.{curriculumFormKeys.id_key}"
																	/>
																	<input
																		class="input"
																		type="hidden"
																		style="display: none;"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_teacher_notes_key}.{teacherNoteIndex}.{curriculumFormKeys.lesson_teacher_note_file_id_key}"
																	/>
																	<input
																		class="input"
																		type="file"
															...
															{#each ($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_misc_materials_key] || []) as miscMaterial, miscMaterialIndex}
																<div>
																	<input
																		...
																		type="hidden"
																		style="display: none;"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_misc_materials_key}.{miscMaterialIndex}.{curriculumFormKeys.id_key}"
																	/>
																	<input
																		class="input"
																		type="hidden"
																		style="display: none;"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_misc_materials_key}.{miscMaterialIndex}.{curriculumFormKeys.lesson_misc_materials_file_id_key}"
																	/>
																	<input
																		class="input"
																		type="file"
