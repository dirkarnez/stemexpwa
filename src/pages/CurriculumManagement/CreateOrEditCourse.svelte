												...
												<div class="column  is-three-quarters">
													<div class="columns is-multiline is-mobile">
														...
														<div class="column is-three-quarters"  style="border-bottom: 1px solid hsl(0deg,0%,86%);">
															...
															{/each}
															<div>
																<InputFileContainer filename={$data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_teacher_notes_key][curriculumFormKeys.lesson_presentation_note_file_name_key]}>
																	<input
																		class="file-input"
																		type="file"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_presentation_notes_key}.{curriculumFormKeys.lesson_presentation_note_file_key}"
