																...
																<InputFileContainer filename={""}>
																	<input
																		...
																		name={
																			...
																			undefined 
																			:
																			`${curriculumFormKeys.levels_key}.${levelIndex}.${curriculumFormKeys.lessons_key}.${lessonIndex}.${curriculumFormKeys.lesson_teacher_notes_key}.${($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_teacher_notes_key] || []).length - 1}.${curriculumFormKeys.lesson_teacher_note_file_key}`)
																		}
																		multiple={false}
