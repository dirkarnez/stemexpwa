															...
															<div>
																<InputFileContainer filename={""}>
																	<input
																		...
																		on:change={e => 
																			handleDocumentChange(e, (file, filename) => {
																				const index = 0;//($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_presentation_notes_key] || []).length;
																				setFields(
