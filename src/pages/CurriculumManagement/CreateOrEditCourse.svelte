																	...
																	<input
																		...
																		on:change={e => 
																			handleDocumentChange(e, (file, filename) => {
																				...
																				setFields(
																					`${curriculumFormKeys.levels_key}.${levelIndex}.${curriculumFormKeys.lessons_key}.${lessonIndex}.${curriculumFormKeys.lesson_presentation_notes_key}.${index}.${curriculumFormKeys.lesson_presentation_notes_file_key}`,
																					file,
																					true,
																				);
																				setFields(
