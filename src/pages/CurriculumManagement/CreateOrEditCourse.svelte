															...
															{#each ($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_presentation_notes_key] || []) as presentationNote, presentationNoteIndex}
																<div>
																	<input
																		class="input"
																		type="hidden"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_presentation_notes_key}.{($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][presentationNoteIndex].{curriculumFormKeys.lesson_presentation_note_file_key}"
																		bind:value={$data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_presentation_notes_key][($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][presentationNoteIndex][curriculumFormKeys.lesson_presentation_note_file_key]}
																	/>
															...
															<div>
																<InputFileContainer filename={""}>
																	<input
																		class="file-input"
																		type="file"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_student_notes_key}.{($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_student_notes_key] || []).length}.{curriculumFormKeys.lesson_student_note_file_key}"
																		multiple={false}
															...
															<div>
																<InputFileContainer filename={""}>
																	<input
																		class="file-input"
																		type="file"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_teacher_notes_key}.{($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_teacher_notes_key] || []).length}.{curriculumFormKeys.lesson_teacher_note_file_key}"
																		multiple={false}
															...
															<div>
																<InputFileContainer filename={""}>
																	<input
																		class="file-input"
																		type="file"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_misc_materials_key}.{($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_misc_materials_key] || []).length}.{curriculumFormKeys.lesson_misc_materials_file_key}"
																		multiple={false}
																		on:change={e => 
																			handleDocumentChange(e, (file, filename) => {
