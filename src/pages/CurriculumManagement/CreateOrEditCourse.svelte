						...
						newIndexedArray(teacherNotesLength).forEach(k => {
							formData.set(
								...
								new File(
									...
									value[curriculumFormKeys.levels_key][i][curriculumFormKeys.lessons_key][i][curriculumFormKeys.lesson_teacher_notes_key][k][curriculumFormKeys.lesson_teacher_note_file_key]
								)
							);
						});
					}
