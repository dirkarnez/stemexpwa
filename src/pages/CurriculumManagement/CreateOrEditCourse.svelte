															...
															{#each ($data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_student_notes_key] || []) as studentNote, studentNoteIndex}
																<div>
																	...
																	<input
																		...
																		type="hidden"
																		style="display: none;"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_presentation_notes_key}.{studentNoteIndex}.{curriculumFormKeys.lesson_presentation_note_file_id_key}"
																	/>
																	<input
																		class="input"
																		type="file"
