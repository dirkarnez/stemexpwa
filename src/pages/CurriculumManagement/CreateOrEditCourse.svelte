															...
															<div>
																<InputFileContainer filename={$data[curriculumFormKeys.levels_key][levelIndex][curriculumFormKeys.lessons_key][lessonIndex][curriculumFormKeys.lesson_teacher_notes_key][curriculumFormKeys.lesson_teacher_note_file_name_key]}>
																	<input
																		class="file-input"
																		type="file"
																		name="{curriculumFormKeys.levels_key}.{levelIndex}.{curriculumFormKeys.lessons_key}.{lessonIndex}.{curriculumFormKeys.lesson_teacher_notes_key}.{curriculumFormKeys.lesson_presentation_note_file_key}"
																		multiple={false}
																		required={true}
																		on:change={e => 
																			handleDocumentChange(e, (file, filename) => {
																				...
																				setFields(
																					`${curriculumFormKeys.levels_key}.${levelIndex}.${curriculumFormKeys.lessons_key}.${lessonIndex}.${curriculumFormKeys.lesson_teacher_notes_key}.${index}.${curriculumFormKeys.lesson_presentation_note_file_key}`,
																					file,
																					true,
																				);
																				setFields(
