...
export const lesson_presentation_note_id_key = "presentation_note_id";
...
export const lesson_student_note_id_key = "student_note_id";
...
export const lesson_misc_materials_id_key = "misc_material_id";
